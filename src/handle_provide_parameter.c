...
/*static void handle_amount_approved(ethPluginProvideParameter_t *msg,
origin_ether_parameters_t *context) { memcpy(context->amount_approved,
msg->parameter, INT256_LENGTH);
}*/
...
// signature: depositSFRXETH(uint256 amount,uint256 minOETH), zapper:
...
// signature: mint(address _asset,uint256 _amount,uint256 _minimumOusdAmount),
// vault: 0x39254033945AA2E4809Cc2977E7087BEE48bd7Ab
...
// signature: redeem(uint256 _amount,uint256 _minimumUnitAmount), vault:
...
// signature: exchange(int128 i,int128 j,uint256 _dx,uint256 _min_dy) curve
// pool: 0x94b17476a93b3262d87b9a326965d1e91f9c13e7
static void handle_curve_exchange(ethPluginProvideParameter_t *msg,
                                  origin_ether_parameters_t *context) {
  switch (context->next_param) {
  case TOKEN_SENT:
    handle_token_sent(msg, context);
...
void handle_provide_parameter(void *parameters) {
  ...
  origin_ether_parameters_t *context =
      (origin_ether_parameters_t *)msg->pluginContext;
