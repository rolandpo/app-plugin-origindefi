...
/*static void set_send_ui(ethQueryContractUI_t *msg, origin_ether_parameters_t
*context) { uint8_t decimals = 0; char *ticker;
...
static void set_send_ui(ethQueryContractUI_t *msg,
  ...
  // Convert to string.
  amountToString(context->amount_sent, INT256_LENGTH, context->decimals_sent,
                 context->ticker_sent, msg->msg, msg->msgLength);
...
static void set_receive_ui(ethQueryContractUI_t *msg,
  ...
  // Convert to string.
  amountToString(context->min_amount_received, INT256_LENGTH,
