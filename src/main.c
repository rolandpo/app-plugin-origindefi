...
static const uint32_t ZAPPER_DEPOSIT_ETH_SELECTOR =
    0xd0e30db0; // signature: deposit(), zapper:
                // 0x9858e47bcbbe6fbac040519b02d7cd4b2c470c66
static const uint32_t ZAPPER_DEPOSIT_SFRXETH_SELECTOR =
    0xd443e97d; // signature: depositSFRXETH(uint256 amount,uint256 minOETH),
                // zapper: 0x9858e47bcbbe6fbac040519b02d7cd4b2c470c66
static const uint32_t VAULT_MINT_SELECTOR =
    0x156e29f6; // signature: mint(address _asset,uint256 _amount,uint256
                // _minimumOusdAmount), vault:
                // 0x39254033945AA2E4809Cc2977E7087BEE48bd7Ab
static const uint32_t VAULT_REDEEM_SELECTOR =
    0x7cbc2373; // signature: redeem(uint256 _amount,uint256
                // _minimumUnitAmount), vault:
                // 0x39254033945AA2E4809Cc2977E7087BEE48bd7Ab
static const uint32_t CURVE_EXCHANGE_SELECTOR =
    0x3df02124; // signature: exchange(int128 i,int128 j,uint256 _dx,uint256
                // _min_dy) curve pool:
                // 0x94b17476a93b3262d87b9a326965d1e91f9c13e7
// static const uint32_t APPROVE_SELECTOR = 0x095ea7b3; // signature:
...
const uint32_t ORIGIN_ETHER_SELECTORS[NUM_SELECTORS] = {
    ZAPPER_DEPOSIT_ETH_SELECTOR, ZAPPER_DEPOSIT_SFRXETH_SELECTOR,
    VAULT_MINT_SELECTOR,         VAULT_REDEEM_SELECTOR,
