...
static const uint32_t UNWRAP_SELECTOR = 0xba087652; // redeem(uint256 shares,address receiver,address owner)
...
const uint8_t WOETH_ADDRESS[ADDRESS_LENGTH] = {0xdc, 0xee, 0x70, 0x65, 0x42, 0x61, 0xaf, 0x21, 0xc4, 0x4c, 0x09, 0x3c, 0x30, 0x0e, 0xd3, 0xbb, 0x97, 0xb7, 0x81, 0x92};
