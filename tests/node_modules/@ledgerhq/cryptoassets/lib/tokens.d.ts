...
export declare function convertERC20([parentCurrencyId, token, ticker, magnitude, name, ledgerSignature, contractAddress, disableCountervalue, delisted, countervalueTicker, compoundFor,]: ERC20Token | PolygonERC20Token): TokenCurrency;
export {};
