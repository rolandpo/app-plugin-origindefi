            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, recursiveFieldStructImplem(destructTypeFromString(fieldType), fieldValue, "".concat(path, ".").concat(fieldName))];
                    case 13:
                        _k.sent();
                        _k.label = 14;
                    case 14:
        ...
        return __generator(this, function (_c) {
            ...
            switch (type) {
                ...
                case "contractName": {
                    ...
                    displayNameLengthBuffer = Buffer.from(intAsHexBytes(displayName.length, 1), "hex");
                    displayNameBuffer = Buffer.from(displayName);
                    filtersCountBuffer = Buffer.from(intAsHexBytes(filtersCount, 1), "hex");
                    sigLengthBuffer = Buffer.from(intAsHexBytes(sig.length / 2, 1), "hex");
 ...
 * @returns {Promise}
 */
export var signEIP712Message = function (transport, path, jsonMessage, fullImplem, loadConfig) {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    cryptoassetsBaseURL = getLoadConfig(loadConfig).cryptoassetsBaseURL;
                    types = sortObjectAlphabetically(unsortedTypes);
                    return [4 /*yield*/, getFiltersForMessage(jsonMessage, cryptoassetsBaseURL)];
                case 1:
                    filters = _j.sent();
                ...
                case 32:
                    ...
                    return [4 /*yield*/, recursiveFieldStructImplem(destructTypeFromString(type), primaryTypeValue, name_3)];
                case 33:
                    _j.sent();
                    _j.label = 34;
                case 34:
