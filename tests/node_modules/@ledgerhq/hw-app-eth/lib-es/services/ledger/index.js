    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, getNFTInfo(contractAddress, chainIdTruncated, loadConfig)];
            case 1:
                nftInfo = _a.sent();
                if (nftInfo) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!shouldResolve.nft) return [3 /*break*/, 2];
                return [4 /*yield*/, loadNftPlugin(contractAddress, selector, chainIdTruncated, loadConfig)];
            case 1:
            ...
            case 2:
                ...
                return [4 /*yield*/, loadInfosForContractMethod(contractAddress, selector, chainIdTruncated, loadConfig)];
            case 3:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _b.label = 3;
                case 3: return [2 /*return*/, mergeResolutions(pluginsResolution, contractResolution)];
            }
        });
    }); }
};
