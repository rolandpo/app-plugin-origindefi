...
export var tokenSelectors = Object.values(ERC20_CLEAR_SIGNED_SELECTORS);
export var nftSelectors = __spreadArray(__spreadArray([], __read(Object.values(ERC721_CLEAR_SIGNED_SELECTORS)), false), __read(Object.values(ERC1155_CLEAR_SIGNED_SELECTORS)), false);
export var mergeResolutions = function (oldResolution, newResolution) {
    var _a, _b;
    var resolutions = {
        nfts: [],
        erc20Tokens: [],
    ...
    for (var key in oldResolution) {
        (_a = resolutions[key]).push.apply(_a, __spreadArray([], __read(oldResolution[key]), false));
    }
    for (var key in newResolution) {
        (_b = resolutions[key]).push.apply(_b, __spreadArray([], __read(newResolution[key]), false));
    }
    return resolutions;
};
