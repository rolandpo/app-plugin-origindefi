...
var EIP712_1 = require("./modules/EIP712");
exports.isEIP712Message = EIP712_1.isEIP712Message;
exports.getFiltersForMessage = EIP712_1.getFiltersForMessage;
...
var Eth = /** @class */ (function () {
    ...
    * @example
     ...
     * @returns {Promise}
     */
    Eth.prototype.signEIP712Message = function (path, jsonMessage, fullImplem) {
        if (fullImplem === void 0) { fullImplem = false; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, EIP712_1.signEIP712Message)(this.transport, path, jsonMessage, fullImplem, this.loadConfig)];
            });
        });
    };
    /**
    ...
    Eth.prototype.starkSignOrder = function (path, sourceTokenAddress, sourceQuantization, destinationTokenAddress, destinationQuantization, sourceVault, destinationVault, amountSell, amountBuy, nonce, timestamp) {
        var sourceTokenAddressHex = (0, utils_1.maybeHexBuffer)(sourceTokenAddress);
        var destinationTokenAddressHex = (0, utils_1.maybeHexBuffer)(destinationTokenAddress);
        var paths = (0, utils_1.splitPath)(path);
    ...
    Eth.prototype.starkSignTransfer = function (path, transferTokenAddress, transferQuantization, targetPublicKey, sourceVault, destinationVault, amountTransfer, nonce, timestamp) {
        var transferTokenAddressHex = (0, utils_1.maybeHexBuffer)(transferTokenAddress);
        var targetPublicKeyHex = (0, utils_1.hexBuffer)(targetPublicKey);
        var paths = (0, utils_1.splitPath)(path);
    ...
    Eth.prototype.starkSignTransfer_v2 = function (path, transferTokenAddress, transferQuantizationType, transferQuantization, transferMintableBlobOrTokenId, targetPublicKey, sourceVault, destinationVault, amountTransfer, nonce, timestamp, conditionalTransferAddress, conditionalTransferFact) {
        var transferTokenAddressHex = (0, utils_1.maybeHexBuffer)(transferTokenAddress);
        var targetPublicKeyHex = (0, utils_1.hexBuffer)(targetPublicKey);
        var conditionalTransferAddressHex = (0, utils_1.maybeHexBuffer)(conditionalTransferAddress);
    ...
    Eth.prototype.starkProvideQuantum = function (operationContract, operationQuantization) {
        var operationContractHex = (0, utils_1.maybeHexBuffer)(operationContract);
    ...
    Eth.prototype.starkUnsafeSign = function (path, hash) {
        var hashHex = (0, utils_1.hexBuffer)(hash);
        var paths = (0, utils_1.splitPath)(path);
    ...
    Eth.prototype.getEIP1024SharedSecret = function (path, remotePublicKeyHex, boolDisplay) {
        var paths = (0, utils_1.splitPath)(path);
        var remotePublicKey = (0, utils_1.hexBuffer)(remotePublicKeyHex);
        var buffer = Buffer.alloc(1 + paths.length * 4 + 32);
        var offset = 0;
        buffer[0] = paths.length;
        paths.forEach(function (element, index) {
