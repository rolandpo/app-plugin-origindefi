...
exports.EIP712_TYPE_ENCODERS = {
    INT: function (value, sizeInBits) {
        if (sizeInBits === void 0) { sizeInBits = 256; }
        ...
        var valueAsBN = new bignumber_js_1["default"](failSafeValue);
        ...
        if (valueAsBN.lt(0)) {
            ...
            var maskAsBN = new bignumber_js_1["default"]("0x".concat(Buffer.alloc(sizeInBytes, 0xff).toString("hex")));
            // two's complement version of value
            valueAsBN = maskAsBN.plus(valueAsBN).plus(1);
        }
        var paddedHexString = valueAsBN.toString(16).length % 2
...
var sortObjectAlphabetically = function (obj) {
    var keys = Object.keys(obj).sort();
    return keys.reduce(function (acc, curr) {
        var value = (function () {
            if (Array.isArray(obj[curr])) {
                return obj[curr].map(function (field) {
                    return (0, exports.sortObjectAlphabetically)(field);
                });
            }
            return obj[curr];
        })();
...
var getSchemaHashForMessage = function (message) {
    var types = message.types;
    var sortedTypes = (0, exports.sortObjectAlphabetically)(types);
 ...
 */
var getFiltersForMessage = function (message, remoteCryptoAssetsListURI) { return __awaiter(void 0, void 0, void 0, function () {
    var schemaHash, messageId, dynamicCAL, e_1;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                schemaHash = (0, exports.getSchemaHashForMessage)(message);
                messageId = "".concat((_b = (_a = message.domain) === null || _a === void 0 ? void 0 : _a.chainId) !== null && _b !== void 0 ? _b : 0, ":").concat((_d = (_c = message.domain) === null || _c === void 0 ? void 0 : _c.verifyingContract) !== null && _d !== void 0 ? _d : NULL_ADDRESS, ":").concat(schemaHash);
                _e.label = 1;
            case 1:
                _e.trys.push([1, 4, , 5]);
                if (!remoteCryptoAssetsListURI) return [3 /*break*/, 3];
                return [4 /*yield*/, axios_1["default"].get("".concat(remoteCryptoAssetsListURI, "/eip712.json"))];
            case 2:
                dynamicCAL = (_e.sent()).data;
                return [2 /*return*/, dynamicCAL[messageId] || eip712_1["default"][messageId]];
            case 3: throw new Error();
            case 4:
                e_1 = _e.sent();
                return [2 /*return*/, eip712_1["default"][messageId]];
