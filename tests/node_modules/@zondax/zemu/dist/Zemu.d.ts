...
import { ButtonKind, type IButton, type IDeviceWindow, type IEvent, type INavElement, type ISnapshot, type IStartOptions, type TModel } from "./types";
export default class Zemu {
    ...
    navigate(path: string, testcaseName: string, navigateSchedule: Array<INavElement | number>, waitForScreenUpdate?: boolean, takeSnapshots?: boolean, startImgIndex?: number, waitForEventsChange?: boolean): Promise<number>;
    ...
    click(endpoint: string, filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<ISnapshot>;
    clickLeft(filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<ISnapshot>;
    clickRight(filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<ISnapshot>;
    clickBoth(filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<ISnapshot>;
    fingerTouch(button: IButton, filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<ISnapshot>;
    runAction(navElement: INavElement, filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<void>;
    runActionBatch(navElements: INavElement[], filename?: string, waitForScreenUpdate?: boolean, waitForEventsChange?: boolean): Promise<void>;
}
